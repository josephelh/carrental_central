"""
Django settings for central_core project.
...
SECRET_KEY = 'django-insecure-n#c_)amhnt*x(2bszgf=1iw^s@ce^d48z$l1cfl!df^@7m2w4!'
...
ROOT_URLCONF = 'central_core.urls'
...
WSGI_APPLICATION = 'central_core.wsgi.application'
